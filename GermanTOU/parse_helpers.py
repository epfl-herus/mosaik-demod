...
from simulators.sparse_simulators import Sparse_TPM
...
try:
    df_hh = pd.read_csv('GermanTOU'+ os.sep + 'daten' + os.sep + 'zve13_puf_hh.csv', sep=';')
    df_akt = pd.read_csv('GermanTOU'+ os.sep + 'daten' + os.sep + 'zve13_puf_takt.csv', sep=';')
    df_pers = pd.read_csv('GermanTOU'+ os.sep + 'daten' + os.sep + 'zve13_puf_pers.csv', sep=';')
...
def plot_active_occupancy(subgroup_kwargs):
    ...
    plt.plot(ten_minutes_axis, np.sum(hh_states, axis=0))